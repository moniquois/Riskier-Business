...
void Start::setMap(){
    ...
    cout <<"3./home/louis/Downloads/MAPS/invalidmap.txt" <<endl; //invalid map contents
    cout <<"4./home/louis/Downloads/MAPS/notconnectedmap.txt"<<endl; //not a connected map
    cout<<"5./home/louis/Downloads/MAPS/medival.map"<<endl; //proper map
    cout<<"6./home/louis/Downloads/MAPS/lordoftherings.txt"<<endl; //real map
    cin >> select;
...
vector<Player*> Start :: getPlayerVector()
{
    return thePlayers;
}
